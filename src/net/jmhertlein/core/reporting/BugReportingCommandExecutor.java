 ...
 * Here's how it works:
 * 
 * 1. Make a child class of this class
 * 2. Override executeCommand- treat it just like onCommand in CommandExecutor or JavaPlugin (Which is-a ComamndExecutor)
 * 3. Override getPlugin, getEnvOptions, getHostname, and getPort
 * 4. getPlugin, Hostname, and Port should be fairly simple to implement. See their jdocs for more specific info
 * 5. getEnvOptions is your chance to get any blob of information that you think you may need beyond the defaults that BugReport already assembles for you. Just return the String containing whatever you want.
 * 
 * The commands are run only when an unhandled exception is thrown during the execution of executeCommand.
 * @author jmhertlein
 */
public abstract class BugReportingCommandExecutor implements CommandExecutor {
     ...
     * 
     * The address and port of the remote server are specified by overriding getHostname and getPort.
     * @param cs
     * @param cmnd
     * @param string
     * @param strings
    ...
    /**
     * Returns any plugin-specific information the developer may want, to help debugging
     * @return
     */
    protected abstract String getEnvOptions();
    
    /**
     * Returns the hostname of the server that the remote BugReportDaemon will be running on
     * @return
     */
    ...
    /**
     * Returns the plugin whose commands we want to report on
     * (just have this method return a reference to your JavaPlugin)
     * @return
     */
