...
public class BugReport implements Serializable {
     ...
     * @param env any plugin-specific environment data necessary to help diagnose the problem
     */
     ...
     * determine what the machine's external IP address is. This permits
     * the IP to be updated by the remote server as the report is received.
     * @param ip 
     */
