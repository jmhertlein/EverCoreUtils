...
public class ChatUtil {
     ...
     * @param strings A 2d array of strings where strings[i] is a line and strings[i][j] is a word on a line
     ...
     * @return the length of the longest string in the column, 0 if there were only empty strings, or -1 if the array was empty
     */
